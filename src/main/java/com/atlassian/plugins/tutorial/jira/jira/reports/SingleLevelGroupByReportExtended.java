package com.atlassian.plugins.tutorial.jira.jira.reports;
...
import com.atlassian.jira.web.bean.FieldScreenBean;
            ...
            throws SearchException
    {
        try
        {
            ...
            Collector hitCollector = new OneDimensionalDocIssueHitCollector(mapper.getDocumentConstant(),
                    statsGroup, issueIndexManager.getIssueSearcher().getIndexReader(),
                    issueFactory, fieldVisibilityManager, readerCache, null, null);
            searchProvider.searchAndSort((request != null) ? request.getQuery() : null, (ApplicationUser) searcher, hitCollector, PagerFilter.getUnlimitedFilter());
            return statsGroup;
        }
        finally
        {
    ...
    public String generateReportHtml(ProjectActionSupport action, Map params) throws Exception
    {
        ...
        try
        {
            startingParams = EasyMap.build(
                    "action", action,
                    "statsGroup", getOptions(request, (User) authenticationContext.getLoggedInUser(), mapper),
                    "searchRequest", request,
                    "mapperType", mapperName,
                    "customFieldManager", customFieldManager,
                    "fieldVisibility", new FieldScreenBean() {
                    },
